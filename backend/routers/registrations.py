...
class _ParticipantPayload(TypedDict):
    last_name: str
    first_name: str
    middle_name: str
    gender: str
...
def register_submit(
    ...
    registration_type = "team" if is_team_registration else "individual"
    with registration_metrics(comp.slug, registration_type) as mark_success:
        ...
        participants_payload: list[_ParticipantPayload] = []
        for i in range(n):
...
"""
        ...
        mark_success(len(participants_payload))
